             ...
             tabPanel("GS-Surv (Custom)",
                      ...
                      #######################################################main bit
                        mainPanel(
                          ...
                          br(),
                          HTML("<p>This tab shows the list of user inputted genes. Enter genes in the side panel either as a csv or by typing into the box. Then go to the split by thirds or median split tabs to perform survival analysis using these genes</p>"),
                          br(),
               ...
               this is then used to generate a Kaplan-Meier plot either splitting data at the median or at the optimal point for discrimination between high and low gene set expression. A histogram of distributions of gene expression and the cut-off is also shown.",
                        ...
                        tabPanel("Split by thirds",
                                 ...
                                 br(),
                                 HTML("<p>This tab performs survival analysis of patients split into three equally sized groups based on average gene set expression of the user inputted gene set.</p>"),
                        ...
                        tabPanel("Median split",
                                 ...
                                 br(),
                                 HTML("<p>This tab performs survival analysis of patients split into two groups using a cut-off at the median average gene set expression of the user inputted gene set.</p>"),
...
##hist - median
  ...
  output$download_cont_coxph_ps<-downloadHandler(
    filename = function(){
      paste0(input$upld_tt,"_continuous_CoxPH.csv")
    },
