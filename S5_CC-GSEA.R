...
tabPanel("CC-GSEA (Custom)",
             ...
             ##CCGSEA custom table
                        HTML("<p> This runs CC-GSEA analysis using the gene, tumour type, correlation method and excluded patients selected in the sidebar with the custom gene set entered above. </p> 
         "),
                        fluidRow(
                          column(8,
